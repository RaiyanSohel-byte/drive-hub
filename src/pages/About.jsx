...
import AboutCompany from "../components/uncommon/AboutCompany";
...
const teamMembers = [
  {
    ...
    role: "Founder & CEO",
    imageUrl:
      "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fG1hbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=600",
  },
  {
    name: "James Miller",
    role: "Marketing Lead",
  ...
  },
  {
    ...
    role: "Head of CE",
    imageUrl:
      "https://images.unsplash.com/photo-1540569014015-19a7be504e3a?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hpbmVzZSUyMG1hbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=600",
  },
  {
    name: "Grafi Jeramiah",
    role: "Sustainability Lead",
    imageUrl:
      "https://images.unsplash.com/photo-1698090272393-c9b69adda131?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGZyZW5jaCUyMG1hbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=600",
  },
  {
    name: "Evan Rodriguez",
    role: "Sales Director",
    imageUrl:
      "https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8c3BhbmlzaCUyMG1hbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=600",
  },
  {
    name: "Lucas Garcia",
    role: "Production Manager",
    imageUrl:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWV4aWNhbiUyMG1hbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=600",
  },
  {
  ...
  {
    name: "Henry Wilson",
    role: "Autonomous Vehicle Eng.",
    imageUrl:
      "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fG1hbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=600",
  },
];
...
const About = () => {
  ...
  const handleScroll = () => {
    if (carouselRef.current) {
      ...
      const index = Math.round(scrollLeft / (width * 0.75)); // 0.75 because card width ~ w-72
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-black dark:via-gray-900 dark:to-black font-sans transition-colors overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(0,0,0,0.05)_1px,transparent_0)] dark:bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.05)_1px,transparent_0)] bg-[size:20px_20px] z-0"></div>

      {/* All visible content above the background */}
      <div className="relative z-10">
        {/* About Company - Scroll Animation */}
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        {/* Team Section */}
        <div className="relative w-full px-4 py-20 sm:px-6 lg:px-8 lg:pt-5 lg:pb-35 max-w-[1200px] mx-auto">
          <motion.div
          ...
          >
            ...
            <div
              ref={carouselRef}
              className="flex lg:hidden gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide px-2 pb-6"
            >
            ...
            {/* Pagination Dots */}
            <div className="flex justify-center mt-2 lg:hidden gap-2">
                ...
                <button
                  ...
                  onClick={() => {
                    carouselRef.current.scrollTo({
                      left: index * (carouselRef.current.offsetWidth * 0.75), // same as scroll calculation
                      behavior: "smooth",
                    });
                  }}
                />
