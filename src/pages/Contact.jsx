...
const Newsletter = () => {
  return (
    ...
    >
      <div className="relative font-sans w-full min-h-screen flex items-center justify-center overflow-hidden p-4 transition-colors duration-300">
        <motion.div
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            A cutting-edge platform where entrepreneurs, indie hackers,
            investors, and VCs connect, collaborate, and fund the next big
            thing.
          </motion.p>
          ...
          <motion.form
            ...
            onSubmit={(e) => {
              e.preventDefault();
              toast.success("Thank you! You’ve been subscribed successfully.");
              e.target.reset();
            }}
          >
