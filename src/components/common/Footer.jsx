...
const Footer = () => {
  return (
    <footer className="bg-linear-to-r from-gray-50 to-gray-100  py-12 px-4 font-inter border-t border-gray-200 ">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 ">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600 ">Email: info@yourbrand.com</p>
          <p className="text-gray-600 ">Phone: +1 (555) 123-4567</p>
        </div>
      </div>
      <div className="text-center text-gray-500  text-sm pt-10 mt-10 border-t border-gray-200 ">
        <p>
          &copy; {new Date().getFullYear()} Raiyan Sohel. All rights reserved.
        </p>
        <p className="mt-1">
          Designed with <span className="text-red-500">&hearts;</span> by Raiyan
          Sohel
        </p>
      </div>
    </footer>
